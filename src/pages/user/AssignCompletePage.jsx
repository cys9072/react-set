      ...
      <Layout mainClassName="PADDING_TOP_ZERO FULL_SIDES">
        ...
        <section className="detail-section">
          ...
          <DetailItem title="총 적립 포인트">
            ...
            <DetailList listTitle="결제 시 사용 포인트" listSubTitle="- 8,300 p" className="ERROR" />
            <DetailList listTitle="총 적립 포인트" listSubTitle="- 23,000 p" className="FONT_SIZE_16 FONT_WEIGHT_SEMI BLUE" />
          </DetailItem>
          <HorizonLineThick />

          <div className="detail-button-box multiple-btn">
            <CustomBtn text="예약 취소" buttonGrade="secondary" addClass="btn--white-bg" onClick={() => setOpenModal(true)} />

            <CustomLink href="/review" linkGrade="secondary" text="별점 남기기" />
          </div>
