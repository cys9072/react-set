...
export default function SnsSignUpTermsOfUsePage() {
    ...
    <>
      ...
      <Layout>
        <CustomModal addClassName="full-size" isOpen={openModal.open} handleClose={() => setOpenModal(INIT_MODAL)}>
          <ModalDangerousHtml title={openModal.title} text={"<p>ssssss</p>"} onClose={() => setOpenModal(false)} />
        </CustomModal>
        ...
        <div className="bottom-button">
          <CustomLink href="/sns-sign-up-form" linkGrade="primary" text="회원가입" />
        </div>
      </Layout>
    </>
  );
